    ...
    <>
      <div className="w-full relative flex items-center justify-center">
        ...
        <div className="md:w-[1180px] 2xl:w-[1400px] absolute flex flex-col md:items-center md:justify-center top-10 md:top-[300px] 2xl:top-[500px] bg-[#471A52] rounded-2xl mx-4 md:mx-0 p-4 md:p-0">
          <p className="font-primarySemibold text-2xl text-[#E9D7FE] py-2 md:py-4">
            About us
          </p>
          <p className="font-primarySemibold text-2xl md:text-5xl text-[#FCFAFF]">
            Providing innovative digital solutions
          </p>
          <p className="font-primaryRegular text-xl text-[#F4EBFF] md:text-center md:p-4 md:pb-10">
      ...
      <div className="w-full bg-[#F4EBFF] flex flex-col md:flex-row items-center justify-between p-4 md:p-10 2xl:px-20 mt-[650px] md:mt-[250px]">
        <div className="md:w-[600px] rounded-lg flex flex-col">
          ...
          <div className="w-[130px] md:w-[155px] h-1 my-1 bg-[#471A52]"></div>
      ...
      <div className="w-full flex flex-col p-4 md:p-10 2xl:px-20 mt-10">
        ...
        <div className="flex flex-col my-4">
          <p className="py-2 font-primarySemibold text-xl md:text-2xl text-gray-700">
            Community
          </p>
          <p className="font-primaryRegular md:text-xl text-gray-500">
      ...
      <div className="w-full flex flex-col p-4 md:p-10 2xl:px-20 mt-10 bg-[#471A52] text-white">
        <div className="font-primarySemibold text-3xl md:text-4xl">
          What we represent
        </div>
        <p className="font-primaryRegular md:text-xl text-white py-2">
      ...
      <div className="flex flex-col items-center justify-center my-10 p-4">
        ...
        <form className="w-full max-w-lg mt-10 font-primaryMedium">
