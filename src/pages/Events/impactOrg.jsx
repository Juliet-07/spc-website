...
const ImpactOrg = () => {
  ...
  const passDetails = [
    {
      id: 1,
      text: "Slot for a rep from the organization to speak in region of operation and grand finale",
    },
    {
      id: 2,
    ...
    {
      id: 3,
      text: "Exhibition space in region of operation and at the grand finale",
    },
    {
      id: 4,
      text: "CEO of organization to be featured in the Africa Digital Innovation Magazine",
    },
    {
      id: 5,
    ...
    {
      id: 6,
      text: "Three VIP delegates pass to participate at the grand finale and region of operation",
    },
    {
      id: 7,
      text: "3-day accomodation provision for CEO of organization at the grand-finale",
    },
  ];
  ...
  const handlePassDetails = async () => {
    ...
    await axios
      .post(url, {
        ...formDetails,
        amount: "10000",
        passType: "IMPACT ORGANISATION PARTNERSHIP",
      })
      .then((response) => {
    ...
    <div className="w-full flex flex-col p-4 2xl:px-20">
      ...
      <div className="w-full flex flex-col md:flex-row items-center justify-between gap-4 md:gap-0 my-6">
        ...
        <div className="w-full md:w-[593px] rounded-xl border border-gray-200 border-t-[16px] border-t-[#471A52] flex flex-col p-4">
          <p className="font-semibold text-3xl text-gray-900">$10,000</p>
          <del className="font-semibold text-2xl text-gray-400">$20,000</del>
          <p className="font-semibold text-gray-900 uppercase">
            impact organization partnership
          </p>
        ...
        <div className="w-full rounded-xl border border-gray-200 border-t-[16px] border-t-[#471A52] flex flex-col p-4">
          <div>
            <div className="flex flex-col">
              <p className="font-semibold text-4xl text-gray-900">$10,000</p>
              <p className="font-semibold text-gray-900 uppercase">
                impact organization partnership
              </p>
            </div>
