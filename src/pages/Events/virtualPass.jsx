...
const VirtualDelegatePass = () => {
  ...
  const passDetails = [
    ...
    {
      id: 2,
      text: "6-months free membership with Africa Digital Innovation Community",
    },
    {
      id: 3,
    ...
    {
      id: 4,
      text: "Chance to win an all expense paid ticket to the grand finale",
    },
  ];
...
export default VirtualDelegatePass;
