  ...
  return (
    <>
      <div className="w-full flex flex-col">
        <Link
          to="/community"
          className="flex items-center p-2 w-[85px] h-10 border border-gray-100 rounded-lg m-4"
        >
          <TbArrowBackUp color="#475467" />
          <span className="text-gray-600 mx-2">Back</span>
        </Link>
        <div className="w-full h-[600px] md:h-[500px] bg-gradient-to-r from-[#FCF1FF] via-[#FDF6FF] to-[#F0B5FF] border border-gray-200 rounded-xl my-4 flex flex-col md:flex-row items-center justify-between md:justify-evenly 2xl:justify-between p-4">
          <div className="md:w-[563px] h-[280px]">
            ...
            <p className="font-primaryRegular md:text-xl text-gray-700 py-3">
              ...
              with building and scaling a startup. Our platform is dedicated to
              helping you navigate the exciting yet complex journey of startup
              growth through mentorship, guidance, and support.
            </p>
        ...
        <div className="w-full flex flex-col items-center justify-center my-10">
          <div className="font-primarySemibold text-2xl md:text-4xl py-2">
            <font color="#BE33E0">How</font> We Stand Out
          </div>
        </div>
        <div>
          <TestimonialCarousel />
